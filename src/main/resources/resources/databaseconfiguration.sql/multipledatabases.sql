...
create index hr_idx_cohort_id_first_res
  on results.heracles_results (cohort_definition_id, analysis_id, count_value, stratum_1)
;

create index hr_idx_cohort_id_analysis_id
  on results.heracles_results (cohort_definition_id, analysis_id)
;

create index hr_idx_cohort_def_id_dt
  on results.heracles_results (cohort_definition_id, last_update_time)
;

create index hr_idx_cohort_def_id
  on results.heracles_results (cohort_definition_id)
;
...
create index hrd_idx_cohort_id_first_res
  on results.heracles_results_dist (cohort_definition_id, analysis_id, count_value, stratum_1)
;

create index hrd_idx_cohort_id_analysis_id
  on results.heracles_results_dist (cohort_definition_id, analysis_id)
;

create index hrd_idx_cohort_def_id_dt
  on results.heracles_results_dist (cohort_definition_id, last_update_time)
;

create index hrd_idx_cohort_def_id
  on results.heracles_results_dist (cohort_definition_id)
;
...
create index hh_idx_cohort_id_analysis_id
  on results.heracles_heel_results (cohort_definition_id, analysis_id)
;

create table results.feas_study_result
(
...
create table results.feas_study_index_stats
(
  study_id integer not null,
  person_count bigint not null,
...
create table results.feas_study_inclusion_stats
(
  study_id integer not null,
...
create table results.ir_strata
(
...
create table results.ir_analysis_result
(
  analysis_id integer not null,
...
create table results.ir_analysis_strata_stats
(
  analysis_id integer not null,
  target_id integer not null,
  outcome_id integer not null,
...
create table results.ir_analysis_dist
(
  analysis_id integer not null,
  target_id integer not null,
  outcome_id integer not null,
